...
const GRAPHQL_ENDPOINT =
  "https://api.studio.thegraph.com/query/51108/atestamint-testing/v2.0.0";
const ERC721DROP_ABI = [
  {
    inputs: [
      {
  ...
  { inputs: [], name: "ProtocolRewards_WithdrawSendFailure", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_createReferral", type: "address" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "uint32", name: "newSchedule", type: "uint32" }],
